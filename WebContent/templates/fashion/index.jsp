...
<!-- about -->
	<div id="about" class="container-bg">
		<div class="container">
			<h3>À PROPOS</h3>
			<p>
			Bienvenue chez <strong>Darou Salam Fashion</strong>, une boutique de prêt à porter offrant les meilleures tendances vêtements pour femmes, hommes et enfants. Procurez-vous notre gamme de robes, hauts, jeans, sacs, chemises, vestes, pulls, manteaux, combinaisons, chaussures, accessoires et plus encore, 
		...
		<div class="container">
			<div class="w3_footer_grids">
				...
				<div class="col-md-3 w3_footer_grid">
					<h3>Nos Articles</h3>
					<ul class="info"> 
						<li><a href="#female" class="scroll">Pour Femme</a></li>
						<li><a href="#male" class="scroll">Pour Homme</a></li>
						<li><a href="#child" class="scroll">Pour Enfant</a></li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Social</h3>
